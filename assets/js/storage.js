(function(global){
  ...
  VA.exportConfigOnly = function(){
    ...
    const payload = { version: "1.2", students: VA.app.students, indicators: VA.app.indicators, exercises: VA.app.exercises.map(function(e){ return { id:e.id, modifier:e.modifier, covers:e.covers.slice() }; }) };
  ...
  VA.exportAll = function(){
    VA.collectConfigOrThrow();
    const payload = { version: "1.2", students: VA.app.students, indicators: VA.app.indicators, exercises: VA.app.exercises.map(function(e){ return { id:e.id, modifier:e.modifier, covers:e.covers.slice() }; }), results: toResultsArray() };
    const blob = new Blob([JSON.stringify(payload, null, 2)], { type: "application/json" });
  ...
  VA.importAnyFromFile = function(file){
    ...
    reader.onload = function(e){
      try {
        ...
        // if (data.version !== "1.2") throw new Error("Versione non supportata (attesa 1.0).");
